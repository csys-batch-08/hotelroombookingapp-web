	...
	<div class="registerForm row">
		...
		<div class="col-sm-6 row verticalRule">
			...
			<div class="col-sm-12">
				...
				<c:out value="${bookWeddingHallDetails.roomNumber}"></c:out>
			</div>
			<div class="col-sm-6">
			...
			<div class="col-sm-6">
				...
				<c:out value="${bookWeddingHallDetails.category}"></c:out>
			</div>
			<div class="col-sm-6">
				<label>Location :</label>
				<c:out value="${bookWeddingHallDetails.location}"></c:out>
			</div>
			<div class="col-sm-12">
				<label>Price :</label>
				<c:out value="${bookWeddingPrice }"></c:out>
			</div>
		</div>
