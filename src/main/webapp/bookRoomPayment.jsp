	...
	<div class="registerForm row">
		...
		<div class="col-sm-6 row verticalRule">
			...
			<div class="col-sm-12">
				...
				<c:out value="${bookRoomDetails.roomNumber}"></c:out>
			</div>
			<div class="col-sm-6">
				<label>Check-In Date :</label>
				<c:out value="${bookRoomDetails.checkIn}"></c:out>
			</div>
			<div class="col-sm-6">
				<label>Check-Out Date :</label>
				<c:out value="${bookRoomDetails.checkOut}"></c:out>
			</div>
			<div class="col-sm-6">
				<label>Category :</label>
				<c:out value="${bookRoomDetails.category}"></c:out>
			</div>
			<div class="col-sm-6">
				<label>Location :</label>
				<c:out value="${bookRoomDetails.location}"></c:out>
			</div>
			<div class="col-sm-12">
				<label>Price :</label>
				<c:out value="${bookRoomPrice }"></c:out>
			</div>
		</div>
