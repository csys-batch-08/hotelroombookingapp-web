...
<link rel="stylesheet" href="assets/css/updateRoomPayment.css">
	...
	<div class="registerForm row">
		...
		<div class="col-sm-6 row verticalRule">
			...
			<div class="col-sm-12">
				...
				<c:out value="${updateRoomDetails.roomNumber}"></c:out>
			</div>
			<div class="col-sm-6">
				<label>Check-In Date :</label>

				<fmt:parseDate value="${updateRoomDetails.checkIn}"
					pattern="yyyy-MM-dd" type="date" var="roomsCheckIn" />
				<fmt:formatDate value="${roomsCheckIn}" pattern="dd-MM-yyyy"
					var="roomsCheckInDate" />
				<c:out value="${roomsCheckInDate}"></c:out>
			</div>
			<div class="col-sm-6">
				<label>Check-Out Date :</label>

				<fmt:parseDate value="${updateRoomDetails.checkOut}"
					pattern="yyyy-MM-dd" type="date" var="roomsCheckOut" />
				<fmt:formatDate value="${roomsCheckOut}" pattern="dd-MM-yyyy"
					var="roomsCheckOutDate" />
				<c:out value="${roomsCheckOutDate}"></c:out>
			</div>
			<div class="col-sm-6">
				<label>Category :</label>
				<c:out value="${updateRoomDetails.category}"></c:out>
			</div>
			<div class="col-sm-6">
				<label>Location :</label>
				<c:out value="${updateRoomDetails.location}"></c:out>
			</div>
			<div class="col-sm-12">
				<label>Price :</label>
				<c:out value="${updateRoomPrice }"></c:out>
			</div>
		</div>
