		...
		<tbody>
			<c:forEach items="${myRoomBookings }" var="rooms">
				<tr>
					...
					<fmt:parseDate value="${rooms.checkIn}" pattern="yyyy-MM-dd " type="date" var="roomCheckIn" />
					<fmt:formatDate value="${roomCheckIn}" pattern="dd-MM-yyyy" var="roomCheckInDate" />
					<td><c:out value="${roomCheckInDate }" ></c:out></td>
					
					<fmt:parseDate value="${rooms.checkOut}" pattern="yyyy-MM-dd " type="date" var="roomCheckOut" />
			...
			<c:forEach items="${myWeddingHallBookings }" var="weddingHalls">
				<tr>
					...
					<fmt:parseDate value="${weddingHalls.checkIn}" pattern="yyyy-MM-dd " type="date" var="weddingCheckIn" />
					<fmt:formatDate value="${weddingCheckIn}" pattern="dd-MM-yyyy" var="weddingCheckInDate" />
					<td><c:out value="${weddingCheckInDate }"></c:out></td>
					<fmt:parseDate value="${weddingHalls.checkOut}" pattern="yyyy-MM-dd " type="date" var="weddingCheckOut" />
					<fmt:formatDate value="${weddingCheckOut}" pattern="dd-MM-yyyy" var="weddingCheckOutDate" />
			...
			<c:forEach items="${myMeetingHallBookings }" var="meetingHalls">
				<tr>
					...
					<fmt:parseDate value="${meetingHalls.checkIn}" pattern="yyyy-MM-dd " type="date" var="meetingCheckIn" />
					<fmt:formatDate value="${meetingCheckIn}" pattern="dd-MM-yyyy" var="meetingCheckInDate" />
					<td><c:out value="${meetingCheckInDate }"></c:out></td>			
					<fmt:parseDate value="${meetingHalls.checkOut}" pattern="yyyy-MM-dd " type="date" var="meetingCheckOut" />
					<fmt:formatDate value="${meetingCheckOut}" pattern="dd-MM-yyyy" var="meetingCheckOutDate" />
