...
public class RoomTransaction implements Serializable {
	...
	public RoomTransaction(int roomNumber, String checkIn, String checkOut, String category, String location,
			Guest guestId) {
		super();
	...
	public String toString() {
		return "RoomDetails->roomNumber=" + roomNumber + ", checkIn=" + checkIn + " ,checkOut=" + checkOut
